		...
		((sizeof(*(object)) == 1)                                                                                      \
				...
				: ((sizeof(*(object)) == 2)                                                                            \
						  ...
						  : ((sizeof(*(object)) == 4)                                                                  \
									...
									: zenny_atomic_fetch_add64(                                                        \
										  (volatile atomic_llong *) (object), (int64_t) (operand)))))
		...
		((sizeof(*(object)) == 1)                                                                                     \
				...
				: ((sizeof(*(object)) == 2)                                                                           \
						  ...
						  : ((sizeof(*(object)) == 4)                                                                 \
									...
									: zenny_atomic_exchange64(                                                        \
										  (volatile atomic_llong *) (object), (int64_t) (desired)))))
...
#	define atomic_compare_exchange_strong(object, expected, desired)                                            \
		(sizeof(*(object)) == 1                                                                                  \
				...
				: (sizeof(*(object)) == 2                                                                        \
						  ? zenny_atomic_compare_exchange16(                                                     \
								(volatile atomic_short *) (object), (int16_t *) (expected), (int16_t) (desired)) \
						  : (sizeof(*(object)) == 4                                                              \
